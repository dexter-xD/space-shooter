...
class Player(pygame.sprite.Sprite):
    ...
    def update(self, df):
        ...
        self.rect.center += self.direction * self.speed * df
...
font = pygame.font.Font(join('fonts', 'Oxanium-Bold.ttf'), 40)
